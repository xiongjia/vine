...
import { embedHtmlPlugin, embedHtmlTemplatePath } from "./vite-embed-html";
...
const cacheDir =
  process.env.VINE_MAPS_CACHE ?? path.join(repoRoot, ".maps-cache");
  ...
  return {
    plugins: [
      ...
      glyphProxyPlugin(
        ...
        GLYPHS_SOURCES[env.VITE_GLYPHS_SRC ?? "protomaps"] ??
          GLYPHS_SOURCES.protomaps ??
          "",
      ),
